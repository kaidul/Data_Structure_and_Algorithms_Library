...
+ [Longest Increasing Subsequence( O(nlogn) )](algorithms/lis.cpp)
...
+ [Modular Mutiplicative Inverse(using Big mod)](algorithms/Power.cpp)
...
+ [Spagrue Grundy Problem](algorithms/grundy.cpp)
...
+ [Berenstain String Hashing](algorithms/berenstain_hashing.cpp)
